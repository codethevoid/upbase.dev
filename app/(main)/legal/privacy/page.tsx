  ...
  return (
    <div className="px-6 py-16 md:py-20">
      <div className="prose-zinc prose dark:prose-invert mx-auto max-w-screen-lg">
        <h2>Restash Privacy Policy</h2>
        <p>
          Your privacy is important to us. It is Restash&apos;s policy to respect your privacy and
          ...
          <a href="https://restash.io">https://restash.io</a>, and other sites we own and operate.
        </p>
        <p>
        ...
        <p>This policy is effective as of November 12, 2024</p>
        ...
        <p>
          ...
          voluntarily supplied to us by our users for the purpose of publication, processing, or
          usage on our platform. All user-generated content is associated with the account or email
          address used to submit the materials.
        </p>
        <p>
          Please be aware that any content you submit for the purpose of publication will be public
          after posting (and subsequent review or vetting process). Once published, it may be
          accessible to third parties not covered under this privacy policy.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            problem-solving providers,providers,professional advisors, and payment systems operators
          </li>
