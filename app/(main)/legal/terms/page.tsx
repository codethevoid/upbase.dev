export default function TermsPage() {
  return (
    <div className="px-6 py-16 md:py-20">
      <div className="prose-zinc prose dark:prose-invert mx-auto max-w-screen-lg">
        <h2>Restash Terms of Service</h2>
        <p>
          These Terms of Service govern your use of the website located at{" "}
          <a href="https://restash.io">https://restash.io</a> and any related services provided by
          Restash.
        </p>
        <p>
          By accessing <a href="https://restash.io">https://restash.io</a>, you agree to abide by
          these Terms of Service and to comply with all applicable laws and regulations. If you do
          not agree with these Terms of Service, you are prohibited from using or accessing this
          website or using any other services provided by Restash.
        </p>
        <p>
          We, Restash, reserve the right to review and amend any of these Terms of Service at our
        ...
        <p>These Terms of Service were last updated on November 12, 2024.</p>
        ...
        <ul>
          ...
          <li>
            ...
            that abuses or disrupts our networks or any other service Restash provides;
          </li>
          <li>
        ...
        <h3>Pricing and Plan Changes</h3>
        <p>
          We reserve the right to change the prices of our plans and any applicable fees at any
          time. Any changes in pricing will take effect upon notice to you, which may be provided by
          email or through an announcement on our website. If you do not agree with the new prices,
        ...
        <p>
          ...
          licensed to Restash and are protected by applicable copyright and trademark law. We grant
        ...
        <p>
          ...
          and may be terminated by Restash at any time.
        </p>
        ...
        <p>
          ...
          run, copy, publicly display, translate, or otherwise create derivative works of your
          content in a manner that is consistent with your privacy preferences and our Privacy
          Policy.
        </p>
        <p>
          The license you grant us can be terminated at any time by deleting your content or
          account. However, to the extent that we (or our partners) have used your content in
          connection with commercial or sponsored content, the license will continue until the
        ...
        <p>
          ...
          To the extent permitted by law, Restash makes no warranties, expressed or implied, and
        ...
        <p>
          In no event shall Restash or its suppliers be liable for any consequential loss suffered
          or incurred by you or any third party arising from the use or inability to use this
          website or the materials on this website, even if Restash or an authorized representative
        ...
        <p>
          ...
          information purposes only. Restash does not warrant or make any representations concerning
        ...
        <h3>Links</h3>
        <p>
          Restash has not reviewed all of the sites linked to its website and is not responsible for
          the contents of any such linked site. The inclusion of any link does not imply
          endorsement, approval or control by Restash of the site. Use of any such linked site is at
          your own risk and we strongly advise you make your own investigations with respect to the
